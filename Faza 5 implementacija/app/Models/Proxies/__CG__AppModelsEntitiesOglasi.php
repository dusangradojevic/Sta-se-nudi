 ...
 */
class Oglasi extends \App\Models\Entities\Oglasi implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Oglasi $proxy) {
    ...
    public function getIdo()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdo();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdo', []);

        return parent::getIdo();
    }
