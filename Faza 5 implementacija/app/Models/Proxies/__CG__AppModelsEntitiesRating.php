 ...
 */
class Rating extends \App\Models\Entities\Rating implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Models\\Entities\\Rating' . "\0" . 'idr', '' . "\0" . 'App\\Models\\Entities\\Rating' . "\0" . 'rate', '' . "\0" . 'App\\Models\\Entities\\Rating' . "\0" . 'idk'];
        }
